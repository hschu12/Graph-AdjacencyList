...
int main()
{
	...
	auto e1 = addEdge(v1, v1, graph::edgeProp::Cost(10), graf);
	auto e2 = addEdge(v1, v2, graph::edgeProp::Cost(10), graf);
	auto e3 = addEdge(v2, v3, graph::edgeProp::Cost(10), graf);
	auto e4 = addEdge(v2, v4, graph::edgeProp::Cost(10), graf);
	auto e5 = addEdge(v3, v4, graph::edgeProp::Cost(10), graf);
